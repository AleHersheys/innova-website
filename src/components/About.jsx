...
const About = () => {
    return (
        <div className="md:px-14 px-4 py-9 max-w-full mx-auto space-y-10 overflow-x-hidden">
            ...
            <div className="flex flex-col md:flex-row-reverse justify-between items-center gap-8">
                <motion.div className="md:w-1/2" variants={fadeIn("up", 0.2)} initial="hidden" whileInView={"show"} viewport={{once: false, amount: 0.7}}>
                    <img src={aboutImg2} alt="" />
                </motion.div>
                <motion.div className="md:w-2/5 flex flex-col items-center md:items-start" variants={fadeIn("right", 0.2)} initial="hidden" whileInView={"show"} viewport={{once: false, amount: 0.7}}>
