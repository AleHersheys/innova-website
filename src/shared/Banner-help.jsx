    ...
    return (
        <div className="gradientBg rounded-xl rounded-bl-[90px] md:p-9 px-4 py-9">
            <div className="flex flex-col md:flex-row-reverse justify-between items-center gap-10">
                ...
                <motion.div className="md:w-3/5" variants={fadeIn("up", 0.2)} initial="hidden" whileInView={"show"} viewport={{ once: false, amount: 0.7 }}>
                    ...
                    <div className="flex flex-col md:flex-row items-center space-y-4 md:space-x-5 md:space-y-0">
                        ...
                        <button className="btnPrimary" onClick={() => window.open("https://www.innovaprosystem.com/terms-and-conditions", "_blank")}>{btn2}</button>
                    </div>
                </motion.div>
            </div>
        </div>
