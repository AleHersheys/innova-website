...
const Footer = () => {
    return (
        <div className="bg-[#999A99] md:px-14 p-4 max-w-screen-2xl mx-auto text-white">
                ...
                <div className="md:w-1/2 flex flex-col md:flex-row flex-wrap justify-between gap-8 items-start">
                    ...
                    <div className="space-y-4 mt-5">
                        ...
                        <ul className="space-y-3">
                            ...
                            <a className="block hover:text-gray-300" onClick={() => window.open("https://www.innovaprosystem.com/terms-and-conditions", "_blank")}>Términos y condiciones</a>
