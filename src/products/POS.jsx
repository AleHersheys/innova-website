...
import pos1 from "../assets/product-2.webp"; // Asegúrate de tener estas imágenes actualizadas
import pos2 from "../assets/product2-2.webp";
import pos3 from "../assets/product2-3.webp";
import pos4 from "../assets/product2-4.webp";
import pos5 from "../assets/product2-5.webp";
...
const Products = () => {
  ...
  // Array con las 5 imágenes del carrusel de POS.
  const images = [pos1, pos2, pos3, pos4, pos5];
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between py-12 px-4 lg:py-24 gap-10 lg:gap-20">
          ...
          >
            ...
            <div className="flex items-start space-x-4 lg:mb-6">
              ...
              <div>
                <h4 className="lg:text-lg font-bold text-[#0F0E0E]">
                  Solo lo fundamental para las ventas
                </h4>
            ...
            <div className="flex items-start space-x-4 lg:mb-6">
              ...
              <div>
                <h4 className="lg:text-lg font-bold text-[#0F0E0E]">
                  La mejor herramienta para tu negocio
                </h4>
                <p className="text-sm text-[#2D2D2D] lg:my-2">
            ...
            >
              <button
                ...
                onClick={() =>
                  window.open(
                    "https://www.mediafire.com/file/gdk0ydqxxrmklww/Innova_POS_%2528Demo%2529.rar/file",
                    "_blank"
                  )
                }
              >
