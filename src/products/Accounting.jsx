...
import accounting from "../assets/product-3.jpg";
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between py-12 px-4 lg:py-24 gap-10 lg:gap-20">
          ...
          >
            ...
            <div className="mt-4 lg:mt-10 flex justify-center lg:justify-start">
              <img src={accounting} alt="Innova Accounting" className="rounded-lg shadow-lg" />
            </div>
          </motion.div>
          {/* Contenido derecha */}
          <motion.div
          ...
          >
            ...
            <motion.div
              ...
              viewport={{ once: true, amount: 0.7 }}
            >
              <button className="btnPrimary" onClick={() => window.open("https://drive.google.com/drive/folders/1q59NcE4bA2EpTxf5MjQLSt4-yU262eHS?usp=drive_link", "_blank")}>Descargar Demo</button>
            </motion.div>
          </motion.div>
        </div>
      </div>
