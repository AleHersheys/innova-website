...
import admin from "../assets/product-1.jpg";
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between py-12 px-4 lg:py-24 gap-10 lg:gap-20">
          ...
          >
            ...
            <motion.div
              ...
              viewport={{ once: true, amount: 0.7 }}
            >
              <button className="btnPrimary" onClick={() => window.open("https://drive.google.com/drive/folders/1HHeE9ukQwF2WO1aWgcuP6-Lwejxk5TKV?usp=drive_link", "_blank")}>Descargar Demo</button>
            </motion.div>
          </motion.div>
        </div>
      </div>
